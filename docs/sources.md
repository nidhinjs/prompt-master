...
| Default "Claude" = Opus 4.8 (Fable 5/Mythos 5 suspended 06-12 → **redeployed 07-01**, default unchanged) | `models.md`, `tool-profiles.md`, SKILL.md Gotchas | Fable 5 / Mythos 5 were disabled for all customers on 2026-06-12 by a US export-control directive; routing "Claude" to a suspended model would break every prompt, so the default reverts to Opus 4.8. Export controls lifted 2026-06-30; Fable 5 redeployed 07-01 (≤50% weekly limits through 07-07, usage credits after; Mythos 5 US-orgs only). Default deliberately stays Opus 4.8 (v1.26.1 decision) — Fable 5 is a selectable option, not the routing target | https://www.anthropic.com/news/fable-mythos-access; https://www.anthropic.com/news/redeploying-fable-5; this project (v1.16 → v1.26.1) |
...
- **Fable 5 redeployment** (export controls lifted 06-30; access 07-01; ≤50% weekly limits through **2026-07-07**, usage credits after; Mythos 5 US-orgs only) — https://www.anthropic.com/news/redeploying-fable-5
- ⚠️ Feature details are **living-docs volatile** (command flags, version gates v2.1.147/154, the 07-07 window) — dated `2026-07-03`; re-verify per 60-day protocol or on next Claude Code release.
